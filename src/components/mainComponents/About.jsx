  ...
  return (
    <main class="about-container" id="about">
      <section class="about-section">
          <img src="src/components/images/amitnyc.jpg" height="400" width="400" class="about-image"></img>
          <div class="about-description">
            <h2 class="about-header">ABOUT ME &#129312;</h2>
            <div class="aboutme-des">
              <p>I’m Amit Krishnaiyer, a student at the University of Illinois Urbana-Champaign&#128312;&#128313;. I’m expecting to graduate in 2025 with a B.S. in Math + Computer Science and a minor in Astronomy. I've been programming for a few years, and I've always been an AI/ML enthusiast, so some of my first serious projects were AIs for games like Tetris, Othello, and Word Hunt. But since I've come to college, I've been exploring a variety of different fields.</p>
              <br></br>
