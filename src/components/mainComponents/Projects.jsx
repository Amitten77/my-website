    ...
    return (
      <div class="full-project-comp" style={{backgroundColor: project.color}}>
        ...
        <div class="full-project-des">
          <p><span class="bold">What is this project:</span> {project.shortDes}</p>
          <br></br>
          <p><span class="bold">How does it work:</span> {project.longerDes}</p>
          </div>
        <div style={{gridColumn: 1, display: 'flex', flexDirection: 'row'}} class="button-control">
