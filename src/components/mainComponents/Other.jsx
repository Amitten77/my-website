    ...
    <main class="other-container" id="other stuff">
      ...
      <section class="other-section">
        ...
        <section class="ted-section other-comp">
          <img src="src/components/images/TedTalk.png" width="400" height="200" class="other-img"></img>
        ...
        <section class="eagle-section other-comp">
          <img src="src/components/images/eagleScout.jpg" width="400" height="200" class="other-img"></img>
        ...
        <section class="BU-section other-comp">
          <img src="src/components/images/BU-Setup.png" width="400" height="200" class="other-img"></img>
